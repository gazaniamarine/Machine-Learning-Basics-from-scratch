...
from supervised_ML.core.regression.ridge_regression import RidgeRegression
...
def run_ridge_exercise():
    ...
    plt.savefig(os.path.join(plots_dir, "ridge_hiring_analysis.png"))
    print(f"Plot saved to: {os.path.abspath(os.path.join(plots_dir, 'ridge_hiring_analysis.png'))}")
