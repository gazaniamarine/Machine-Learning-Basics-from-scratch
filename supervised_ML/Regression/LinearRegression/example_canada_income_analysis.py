...
def run_canada_income_exercise():
    ...
    plt.xlabel("Year"); plt.ylabel("Income (US$)"); plt.title("Canada Per Capita Income Forecaster")
    plt.legend(); plt.grid(True)
    
    plt.savefig(os.path.join(current_dir, "example_canada_income_analysis.png"))
    print(f"Visualization saved to: {current_dir}")
